...
{
    private const CORE_OWNER_PERMISSIONS = [
        'Admin.Dashboard',
        'Admin.Orders',
        'Admin.AssignOrders',
        'Admin.Menus',
    ...
    private const CORE_BRANCH_MANAGER_PERMISSIONS = [
        'Admin.Dashboard',
        'Admin.Orders',
        'Admin.AssignOrders',
        'Admin.Menus',
    ...
    private const CORE_STAFF_MANAGER_PERMISSIONS = [
        'Admin.Staffs',
        'Admin.StaffGroups',
    ];
    ...
    public static function all(): array
    {
        ...
        return [
            'owner' => self::PROFILES['owner'] + [
                'permissions' => $all,
                'optional_permissions' => array_merge(self::CORE_OWNER_PERMISSIONS, self::CORE_STAFF_MANAGER_PERMISSIONS),
            ],
            ...
            ], ['Restaurant.Operations.HeadOfficeDashboard']), 'optional_permissions' => self::CORE_BRANCH_MANAGER_PERMISSIONS],
